...
/* Previously, stickers was a string or a key name, so .replaceAll() could be used directly.
   Later, it was changed to an array of objects (object array), where each sticker is an object with properties like name.
   Therefore, you can no longer apply string methods directly to the entire sticker. */
